...
class ScrollableLabelButtonFrame(ctk.CTkScrollableFrame):
    ...
    def add_item(self, item_id, item_name, progress=0, image=None):
        ...
        remove_button = ctk.CTkButton(self, text="Sil", width=75, height=24)  # Remove button
        ...
        remove_button.grid(row=len(self.remove_button_list), column=4, pady=(0, 10), padx=5)  # Add Remove button to UI
